...
public class ListenFeaturesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listen_features);
    ...
    private void speakFeatures() {
        TextView featuresTextView = findViewById(R.id.featuresTextView);

        String features = "Say \"Read\" to enable the camera to read text.\n" +
                "Say \"Location\" to get your current location.\n" +
                "Say \"Object\" to detect objects using the camera.\n" +
                "Say \"Currency\" to detect currency using the camera.\n" +
                "Say \"Reminder\" to set reminders.\n" +
                "Say \"datetime\" to get current date and time.\n" +
                "Say \"battery\" to get information about current battery level.\n" +
                "Say \"calculator\" to use the calculator feature.\n" +
                "Say \"Emergency\" to acknowledge emergencies.\n" +
                "Say \"Music\" to play music.\n" +
                "Say \"Exit\" to Leave this Application.\n" +
                "Swipe left and say what you want. Swipe right to listen to the features of the application again." ;

        featuresTextView.setText(features);

        // Speak the features
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            textToSpeech.speak(features, TextToSpeech.QUEUE_FLUSH, null, null);
        }
    }
